[![CI](https://github.com/chaithyagr/joint_optimization_mri/actions/workflows/ci-build.yml/badge.svg?branch=main)](https://github.com/chaithyagr/joint_optimization_mri/actions?query=workflow%3ACI)
